...
<html lang="en">
<head>
<title>Bacon Hub Features</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container">
        ...
        <div class="feature-box">
            ...
            <h3>Combat Cheats</h3>
            <ul>
                <li>Kill Aura (Guards)</li>
                <li>Kill Aura (Inmates)</li>
                <li>Kill Aura (Neutral)</li>
                <li>Kill Aura (Criminals)</li>
                <li>Kill Aura</li>
                <li>Reset On Arrest</li>
                <li>Auto Give All Guns</li>
                <li>Gun Mod</li>
                <li>Give All Guns</li>
            </ul>
            ...
            <ul>
                ...
                <li>Click Destroy</li>
                <li>Rejoin Server</li>
                <li>Open Prison Gate</li>
                <li>Auto Pickup Keycard</li>
                <li>Spawn Items</li>
            </ul>
            <h3>Teams</h3>
            <ul>
            ...
            <ul>
                ...
                <li>No Fences</li>
                <li>No Trees</li>
                <li>No Prison Trees</li>
                <li>No Square Trees</li>
            </ul>
            <h3>Teleports</h3>
            <ul>
                <li>All Locations</li>
